...
model = pickle.load(open(r'C:\Users\user\Desktop\MACHINE_LEARNING\SALARY_PREDICTION project\linear_regression_model.pkl', 'rb'))
...
st.write("The model build by abhisai")